...
const Services = () => {
  ...
  const serviceColors = ['bg-medical-blue', 'bg-amber-500', 'bg-medical-red', 'bg-gray-900', 'bg-medical-blue', 'bg-amber-500', 'bg-medical-red', 'bg-gray-900'] as const
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold font-heading mb-6">
            Our <span className="text-gradient">Core Ventures</span>
          </h2>
              ...
              >
                ...
                <div className={index % 2 === 0 ? '' : 'lg:col-start-2'}>
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-medical-blue/5 to-medical-red/5 p-6 rounded-[7px] border border-medical-blue/10">
                      <h4 className="text-xl font-bold text-medical-blue mb-4 flex items-center gap-2">
                      ...
                      <div className="grid md:grid-cols-2 gap-3">
                        {service.features.map((feature, idx) => (
                          <div key={idx} className="flex items-center gap-3">
                            <div className="w-2 h-2 bg-medical-red rounded-[7px] flex-shrink-0" />
                        ...
                        <>
                          ...
                          <div className="opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300">
                            <button
                              ...
                              className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/50 hover:bg-black/70 text-white rounded-[7px] flex items-center justify-center transition-colors z-30"
                            >
                              <ChevronLeft className="w-5 h-5" />
                            </button>
                            <button
                              onClick={() => nextMedia(service.id, service.media.length)}
                              className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/50 hover:bg-black/70 text-white rounded-[7px] flex items-center justify-center transition-colors z-30"
                            >
