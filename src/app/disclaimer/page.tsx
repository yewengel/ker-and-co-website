  ...
  return (
    <main className="relative min-h-screen bg-gray-50">
      ...
      <section className="pb-10 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-white rounded-[7px] md:rounded-[8px] border border-gray-100 shadow-lg p-4 md:p-8 space-y-2 md:space-y-4 text-[10px] md:text-base text-gray-700">
