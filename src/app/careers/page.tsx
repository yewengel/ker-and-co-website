        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-2xl md:text-6xl font-bold text-gray-900 mb-3 md:mb-5 font-heading">
              Careers at <span className="text-gradient">{brand.shortName}</span>
            </h1>
      ...
      <section className="pb-10 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-3 gap-2 md:gap-6">
          {values.map((item, idx) => (
            ...
            >
              <div className="inline-flex w-8 h-8 md:w-12 md:h-12 rounded-[7px] md:rounded-[8px] bg-medical-blue/10 items-center justify-center">
                <item.icon className="w-4 h-4 md:w-6 md:h-6 text-medical-blue" />
              </div>
        ...
        <div className="max-w-7xl mx-auto mt-4 md:mt-10 bg-white rounded-[7px] md:rounded-[8px] border border-gray-100 shadow-lg p-4 md:p-8">
          ...
          <div className="mt-4 md:mt-8 grid grid-cols-2 gap-2 md:gap-5">
            {openings.map((job) => (
              <div key={job.title} className="rounded-[7px] md:rounded-[8px] bg-gray-50 border border-gray-100 p-3 md:p-6">
